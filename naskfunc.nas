...
;攃eflggs揑?愭?擖?丆慠岪嵞樃?拞攃泙揑??弌棃?EAX曉夞
_io_load_eflags:
		PUSHFD		; push EFLAGS
		POP		EAX
		RET		
		
;攃EAX揑??擖?丆嵞攃?槩???eflags		
_io_store_eflags:
		MOV		EAX,[ESP + 4 ]
		PUSH	EAX
		POPFD
...
_memtest_sub:		; unsigned int memtest_sub( unsigned int start, unsigned int end)
	PUSH		EDI		;曐懚?嵄婑懚婍丆?岪柺巊梡?嵄婑懚婍岪擻?夬?
	PUSH		ESI
	PUSH		EBX
	MOV			ESI, 0xaa55aa55		;pat0
	MOV			EDI, 0x55AA55AA		;pat1
	MOV			EAX, [ESP + 12 + 4]	; i = start		;?棦揑12??惀丗EDI ESI EBA丆4惀曉夞抧毈
mts_loop:
	MOV 		EBX, EAX
